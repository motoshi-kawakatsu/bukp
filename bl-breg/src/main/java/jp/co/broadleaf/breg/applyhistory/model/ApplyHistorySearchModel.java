 ...
 * 申請履歴検索のModelのクラス。
 */
public class ApplyHistorySearchModel {
  ...
  @Override
  public int hashCode() {
    return new HashCodeBuilder(17, 37).append(applyNo).append(blApplyResultsFlg).append(applyDateTimeFrom).append(applyDateTimeTo)
        .append(tbsPartsCode).append(primePartsNo).append(applyType).append(partsMakerCd).append(joinSourPartsNoWithH)
        .append(applySort).append(page).append(rows).append(makerCd).toHashCode();
  }
  ...
  public boolean equals(Object obj) {
    ...
    ApplyHistorySearchModel other = (ApplyHistorySearchModel) obj;
