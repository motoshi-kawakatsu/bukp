 ...
 * 商品マスタ(メーカー)ワーク
 */
@Entity(name = "w_goods_master_maker", type = "maker")
@OptimisticConcurrency(resolver = BroadleafOptimisticConcurrencyResolver.class)
public class GoodsMasterWorkMaker extends BroadleafDomainEntity<GoodsMasterWorkMakerId> {
   ...
   * @param id ID
   */
  public GoodsMasterWorkMaker(GoodsMasterWorkMakerId id) {
   ...
   */
  @Override
  public GoodsMasterWorkMakerId identifier() {
    return new GoodsMasterWorkMakerId(getPrmSetDtlNo1(), getPartsMakerCd(), getPrimePartsNoWithH());
  }
