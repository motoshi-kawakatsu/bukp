 ...
 * 結合マスタ(メーカー)ワーク
 */
@Entity(name = "w_join_master_maker", type = "maker")
@OptimisticConcurrency(resolver = BroadleafOptimisticConcurrencyResolver.class)
public class JoinMasterWorkMaker extends BroadleafDomainEntity<JoinMasterWorkMakerId> {
   ...
   * @param id ID
   */
  public JoinMasterWorkMaker(JoinMasterWorkMakerId id) {
   ...
   */
  @Override
  public JoinMasterWorkMakerId identifier() {
    return new JoinMasterWorkMakerId(getPrmSetDtlNo1(), getPartsMakerCd(), getTbsPartsCode(), getJoinSourceMakerCode(), getPrmSetDtlNo2(), getJoinSourPartsNoWithH(), getJoinDispOrder());
  }
