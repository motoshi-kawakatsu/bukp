 ...
 * セットマスタ(メーカー)本
 */
@Entity(name = "m_set_maker", type = "maker")
@OptimisticConcurrency(resolver = BroadleafOptimisticConcurrencyResolver.class)
public class SetMasterMaker extends BroadleafDomainEntity<SetMasterMakerId> {
   ...
   * @param id ID
   */
  public SetMasterMaker(SetMasterMakerId id) {
   ...
   */
  @Override
  public SetMasterMakerId identifier() {
    return new SetMasterMakerId(getPrmSetDtlNo1(), getPartsMakerCd(), getSetMainPartsNo(), getSetDispOrder());
  }
