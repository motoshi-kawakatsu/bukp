...
/**
 * 商品マスタ(common)のDtoのクラス。
 */
public class GoodsMasterCommonDto implements Serializable {
  /**  */
  private static final long serialVersionUID = -2558109308183625431L;
  ...
  public int hashCode() {
    return new HashCodeBuilder(17, 37).append(uuid).append(insDtTime).append(updDtTime).append(insAccountId)
        ...
        .append(goodsWeight).append(weightUnit).append(url1).append(url2).append(url3).append(imageNo).append(applyNo)
        .append(dealFlg).append(deleteFig).append(deleteReason).append(errFlg).append(blEntryFlg).append(startTime)
        .toHashCode();
  }
  ...
  public boolean equals(Object obj) {
    ...
    GoodsMasterCommonDto other = (GoodsMasterCommonDto) obj;
    return new EqualsBuilder().append(uuid, other.uuid).append(insDtTime, other.insDtTime)
        ...
        .append(applyNo, other.applyNo).append(dealFlg, other.dealFlg).append(deleteFig, other.deleteFig)
        .append(deleteReason, other.deleteReason).append(errFlg, other.errFlg).append(blEntryFlg, other.blEntryFlg)
