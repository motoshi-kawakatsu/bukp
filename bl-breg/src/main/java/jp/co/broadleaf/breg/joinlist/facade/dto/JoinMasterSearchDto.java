 ...
 * 結合マスタの検索条件のDtoクラスです。
 */
public class JoinMasterSearchDto implements Serializable {

  /**  */
  private static final long serialVersionUID = -9072394651094481505L;
  /**
   * BLコード
   */
  ...
  public boolean equals(Object obj) {
    ...
    JoinMasterSearchDto other = (JoinMasterSearchDto) obj;
