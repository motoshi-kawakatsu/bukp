...
public class Message extends BroadleafDomainEntity<MessageId> {
  ...
  public Message(MessageId id) {
    ...
    setMsgId(id.getMsgId());
    setLocaleId(id.getLocaleId());
  }
  ...
  public MessageId identifier() {
    return new MessageId(getApplyStartDt(), getMsgId(), getLocaleId());
  }
