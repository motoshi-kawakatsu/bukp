...
/**
 * <pre>
 * UserSettingValidatorRuleTwo　のクラス
 * </pre>
 */
public class UserSettingValidatorRuleTwo implements FieldValidatorRule<String>{
  ...
  public boolean match(String fieldName, String fieldValue) {
    return UserSettingValidatorTwo.isValid(Boolean.valueOf(fieldValue));
  }
